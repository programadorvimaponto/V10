        ...
        public override void DepoisDeGravar(string Fornecedor, ExtensibilityEventArgs e)
        {
            ...
            if (Module1.VerificaToken("AlertaCriarFornecedor") == 1)
            {
                ...
                if (listEnt.Vazia() == false)
                {
                    ...
                    VarMensagem = VarTextoInicialMsg + Strings.Chr(13) + Strings.Chr(13) + Strings.Chr(13) + "Os seguintes Fornecedores não estão criados na Mundifios:" + Strings.Chr(13) + Strings.Chr(13) + ""
                                + VarMensagem + ""
                                + "Cumprimentos";
