...
Namespace CopiaEntreEmpresas
    Public Class BasIsFichaFornecedor
        ...
        Public Function ValidacoesCamposUtilizador() As Boolean
            ...
            If Len(Me.Fornecedor.CamposUtil("CDU_NomeEmpresaGrupo").Valor & "") = 0 Then

                'Se não tiver empresa definida, garante que o campo de utilizador de fornecedor está vazio
                Me.Fornecedor.CamposUtil("CDU_CodigoFornecedorGrupo").Valor = ""
            ...
            Else
                ...
                Me.Fornecedor.CamposUtil("CDU_NomeEmpresaGrupo").Valor = UCase(Me.Fornecedor.CamposUtil("CDU_NomeEmpresaGrupo").Valor & "")

                If Not GetTrueIfEmpresaValida(Me.Fornecedor.CamposUtil("CDU_NomeEmpresaGrupo").Valor & "") Then
                    'Se a empresa não for válida, aviso (na outra função) e retorno falso
                    ValidacoesCamposUtilizador = False : Exit Function

                Else

                    If GetTrueIfFornecedorValido(Me.Fornecedor.CamposUtil("CDU_NomeEmpresaGrupo").Valor & "", Me.Fornecedor.CamposUtil("CDU_CodigoFornecedorGrupo").Valor & "") = False Then
