...
'Public Class FrmFornecedoresCertsFilopaViews
'    Inherits CustomForm
...
'        'Classes Oekotex
'        Me.LookUpEditClasse.EditValue = listCerts.Valor("CDU_OekotexClasse")
'        Me.LookUpEditClasse2.EditValue = listCerts.Valor("CDU_OekotexClasse2")
...
'        BSO.Base.Clientes.ActualizaValorAtributos(Me.TextEditCodigoCliente.EditValue, Campos)
'        CopiaMundifios()
...
'    Function CopiaMundifios()

'        On Error GoTo TrataErro
'        Dim ent As String
'        ent = BSO.Base.Clientes.DaValorAtributo(Me.TextEditCodigoCliente.EditValue, "CDU_EntidadeInterna")
...
'            Else
'                MsgBox("Filopa - Dados gravados com sucesso!" & Chr(13) & Chr(13) & "Mundifios - Erro:Fornecedor inexistente(EntidadeInterna " & BSO.Base.Clientes.DaValorAtributo(Me.TextEditCodigoCliente.EditValue, "CDU_EntidadeInterna") & ")", vbInformation)
'            End If
'            FechaObjEmpresa
'        End If
'        Exit Function
...
'        Me.TextEditCliente.EditValue = BSO.Base.Clientes.DaValorAtributo(Me.TextEditCodigoCliente.EditValue.Text, "Nome")
...
'            PSO.AbreLista(0, "Clientes", "Cliente", Me, Me.TextEditCodigoCliente.EditValue, "mnuTabCliente", , , , , , True)
